...
public class PollRequestAdd {
	...
	private List<OptionPollRequestAdd> optionPoll;
	 ...
	 */
	public List<OptionPollRequestAdd> getOptionPoll() {
		return optionPoll;
	}
	 ...
	 */
	public void setOptionPoll(List<OptionPollRequestAdd> optionPoll) {
